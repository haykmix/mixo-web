const en = {
    ...
    posts: [
      {
        ...
        text: [
          ...
          {
            title: `A total experience`,
            text: `Two years of work have resulted in a vending machine that can be customized with different finishes 
          ...
          {
            title: `Less waste and waste`,
            text: `In addition to reducing the time customers spend queuing at the bar of discos or at concerts, solutions such as 
      ...
      },
      {
        ...
        title:
          "This Uruguayan wants to change the long waits for a drink in recitals and massive events: this is how Mixo works",
        text: [
  ...
  advancedCalc: {
    ...
    subtitle: "Results",
    items: ["Total income", "Total costs", "Net income"],
    inputs: {
      days: "Operating days",
      hours: "Hours per day",
      price: "Price",
  ...
  simpleCalc: {
    ...
    items: ["Total revenue", "Total costs", "Net revenue"],
    inputs: {
      days: "Operating days",
      month: "Operational months",
      price: "Price",
    },
    labels: {
      days: "*Days open a week",
      month: "*Months of opening",
      price: "*Average price of the package",
    },
    results: {
      totalIncome: "Total Revenue",
    },
    daysError: "Enter the correct opening days",
    monthError: "Enter the correct opening months",
    priceError: "Enter the price above 0",
...
const es = {
  ...
  advancedCalc: {
    ...
    subtitle: "Resultados",
    items: ["Ingresos totales", "Costes totales", "Ingresos netos"],
    inputs: {
    ...
    labels: {
      ...
      bartender: "*Número de camareros durante que seran asistidos por Mixo",
    },
    results: {
  ...
  simpleCalc: {
    ...
    inputs: {
      days: "Días operativos",
      month: "Meses operativos",
      price: "Precio",
    },
    labels: {
      days: "*Días abiertos a la semana",
      month: "*Meses de apertura del local",
      price: "*Precio promedio del combinado",
    },
    results: {
      totalIncome: "Ingresos Totales",
    },
    daysError: "Introduce los días de apertura correctos",
    monthError: "Introduce los meses de apertura correctos",
    priceError: "Introduce el precio superior a 0",
    emptyError: "Todos los campos son obligatorios",
    button: "Calcular",
    year: "(Año)",
  },
};
